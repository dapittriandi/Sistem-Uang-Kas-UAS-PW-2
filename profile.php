...
<head>
  ...
  <style>
	...
	.card li  img {
		...
		max-height: 100px; 
		border-radius: 15px; 
		border: 3px solid rgba(200, 200, 201, 0.635);
      ...
      <div class="container-fluid">
        <div class="card">
		  <ul class="list-group list-group-flush">
		    <li class="list-group-item"> <?php $photoPath = 'assets/upload/' . $dataUser['photo']; ?>
                             <img src="<?php echo $photoPath; ?>" alt="Photo Profile"></li>
		    ...
		    <li class="list-group-item">Jenis Kelamin: <?= $dataUser['jenis_kelamin']; ?></li>
		    <li class="list-group-item">Asal: <?= $dataUser['asal']; ?></li>
			<li class="list-group-item">No Hp: <?= $dataUser['no_hp']; ?></li>
		  </ul>
		</div>
		    	...
		    	<div class="modal-content">
			      ...
			      <div class="modal-body">
			        <div class="form-group">
			        	...
			        	<input type="file" name="photo" id="photo" class="form-control" required value="<?= $dataUser['photo']; ?>">
			        </div>
			        <div class="form-group">
			        ...
			        <div class="form-group">
					 ...
					 <div class="form-group">
			        	...
			        	<input type="text" name="no_hp" id="no_hp" class="form-control" required value="<?= $dataUser['no_hp']; ?>">
			        </div>
			      </div>
